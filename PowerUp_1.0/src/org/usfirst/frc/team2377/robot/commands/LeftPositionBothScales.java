...
public class LeftPositionBothScales extends CommandGroup {
	...
	public LeftPositionBothScales() {
		...
		if (FmsSubSystem.getRightScaleActive(Robot.switchScaleLayout)) {
			...
			addSequential(new DriveForward(Robot.L2RSc_Leg_1, .35));
			addSequential(new AutoRotateRight(Robot.RotateRight, .6));
			addSequential(new DriveForward(Robot.L2RSc_Leg_2, .35));
			addSequential(new AutoRotateLeft(Robot.RotateLeft, .6));
			addSequential(new DriveForward(Robot.L2RSc_Leg_3, .35));
			addSequential(new AutoRotateLeft(Robot.RotateLeft, .6));
