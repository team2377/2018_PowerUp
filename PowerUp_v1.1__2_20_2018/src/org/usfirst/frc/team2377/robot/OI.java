...
public class OI {
	...
	public OI() {
		...
		closeGripper = new JoystickButton(manipulatorJoystick, RobotMap.MANIPULATOR_RIGHTBUMPER);// manipulator
																									// RightBumper
		gearLeftTrigger = new JoystickButton(driveJoystick, RobotMap.DRIVE_LEFTBUMPER);// drive RightBumper
		gearRightTrigger = new JoystickButton(driveJoystick2, RobotMap.DRIVE_RIGHTBUMPER);// drive RightBumper
		...
		halfSpeed = new JoystickButton(driveJoystick, RobotMap.AXIS_D_LEFTTRIGGER_HALFSPEED);
	...
	public double getDriverRightDriveValue() {
		...
		return getAxisValue(driveJoystick, RobotMap.AXIS_D_RIGHTDRIVE);
	}

	public double getDriverLeftDriveValue() {

		return getAxisValue(driveJoystick, RobotMap.AXIS_D_LEFTDRIVE);
	}
