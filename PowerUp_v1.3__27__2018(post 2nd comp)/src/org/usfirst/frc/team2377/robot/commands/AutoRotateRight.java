...
public class AutoRotateRight extends Command {
	...
	protected void initialize() {
		// was a reset gyro.c switched to reset encoder
	...
	protected void execute() {
		...
		if (currentAngle < angle) {
			...
			RobotMap.driveSystemRobotDrive21.tankDrive(speed, -speed / 100);
			RobotMap.driveSystemRobotDrive41.tankDrive(speed, -speed / 100);
