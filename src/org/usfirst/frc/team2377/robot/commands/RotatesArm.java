...
public class RotatesArm extends Command {
	...
	private static enum statetype{LOOKINGFORBUTTON,MOVINGTOLIMIT};
    ...
    protected void execute() {
    	...
    	case LOOKINGFORBUTTON:
    		...
    		if(Robot.oi.manipulatorJoystick.getRawButton(3))//TODO give alphabetical value
    	...
    	case MOVINGTOLIMIT:
    		...
    		{
    			if(RobotMap.gripperStoredLimitSwitch.get()==false)
				{
					//RobotMap.driveSubsystemRotateArm.arcadeDrive(-.5, 0);
					RobotMap.armMotor.set(-.5);
				}
